...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'User', targetEntity: TicketOfUser::class, orphanRemoval: true)]
    ...
    public function removeTicketOfUser(TicketOfUser $ticketOfUser): self
    {
        if ($this->ticketOfUsers->removeElement($ticketOfUser)) {
            ...
            if ($ticketOfUser->getUser() === $this) {
                $ticketOfUser->setUser(null);
            }
        }
